 ...
 * fingerprint (e.g. "operating inside pi, a coding agent harness") or a duplicate
 * environment preamble is present, and is otherwise an exact no-op. This matters
 * because pi's prompt can arrive under a NON-pi adapter — Pylon routes pi traffic as
...
const plugin: Transform = {
  ...
  // content-based no-op when no targeted block is present.
